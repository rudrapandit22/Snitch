  ...
  return (
    <div className="relative min-h-screen w-full bg-[#FAF9F5] flex items-center justify-center p-4 overflow-hidden font-sans">
      ...
      <div className="relative w-full max-w-md bg-white border border-[#EBE7DF] rounded-3xl p-8 md:p-12 shadow-[0_8px_30px_rgb(230,225,215,0.25)] overflow-hidden transition-all duration-300">
        ...
        {(error || localError) && (
          <div className="mb-6 p-4 rounded-xl bg-red-50 border border-red-200 text-red-700 text-sm flex items-start space-x-3 relative z-10">
        ...
        {successMsg && (
          <div className="mb-6 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm flex items-start space-x-3 relative z-10">
            <svg className="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label htmlFor="password" className="block text-[#1C1A17] text-[10px] font-bold uppercase tracking-wider">
                Password
              </label>
              <a href="/forgot-password" className="text-[#8C7A65] hover:text-black transition-colors text-[10px] uppercase font-bold tracking-wider">
                Forgot?
              </a>
            </div>
